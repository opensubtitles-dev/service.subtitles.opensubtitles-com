...
"""
    ...
    # inverted 512x512 logo (white glyph on black) - the original's white
    # background glares on Kodi's dark skins.
    shutil.copy(os.path.join(REPO_ROOT, "resources", "media", "os_logo_512x512_inverted.png"),
